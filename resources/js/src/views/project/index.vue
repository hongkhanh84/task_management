                        ...
                        <div class="space-y-1">
                            ...
                            <button type="button"
                                ...
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0">
                                        <circle opacity="0.5" cx="12" cy="13" r="9" stroke="#1C274C"
                                            stroke-width="1.5" />
                        ...
                        <div class="ltr:mr-3 rtl:ml-3 flex items-center">
                            ...
                            <div class="relative group flex-1">
                                <input type="text" class="form-input peer ltr:!pr-10 rtl:!pl-10"
                                    placeholder="Search Project..." v-model="searchTask" @keyup="searchTasks()" />
                                <div
...
const searchTasks = (isResetPage = true) => {
    ...
    let res;
    if (selectedTab.value === 'running' || selectedTab.value === 'new' || selectedTab.value === 'trash') {
