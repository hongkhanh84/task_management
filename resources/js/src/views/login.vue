                        ...
                        <div class="dropdown">
                            <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end'" offsetDistance="8">
                                ...
                                <template #content="{ close }">
                                    <ul class="!px-2 text-dark dark:text-white-dark grid grid-cols-2 gap-2 font-semibold dark:text-white-light/90 w-[290px]">
        ...
        login() {
            axios.post('/api/login', {
                ...
                .then(response => {
                    ...
                    const store = useAppStore();
                    // Call the setToken action to store the token in the store
